...
export const fortuneServices: FortuneService[] = [
  {
    ...
    description: 'あなたの夢をAIが解読し、深層心理を紐解きます',
    icon: '🌙',
    color: '#b5a4d6',
    path: '/dream',
  },
  {
    ...
    name: 'タロット占い',
    subtitle: 'AI Tarot',
    description: 'AIがタロットカードを引き、あなたの運命を読み解きます',
    icon: '🃏',
    color: '#d4a5b6',
    path: '/tarot',
  },
  ...
  },
  {
    ...
    description: 'お名前の画数からAIが運勢を読み解きます',
    icon: '✍️',
    color: '#a0c4ff',
    path: '/name-fortune',
  },
