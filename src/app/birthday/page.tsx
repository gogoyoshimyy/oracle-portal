      ...
      <motion.div initial={{ y: -30, opacity: 0 }} animate={{ y: 0, opacity: 1 }}>
        <div className="text-center mb-2">
          <div className="flex justify-center mb-3">
            <FortuneIcon iconKey="gift" size={40} color="var(--accent)" strokeWidth={1.3} />
          </div>
          <h1 className="text-3xl font-bold gradient-text font-mincho" style={{ letterSpacing: '0.1em' }}>誕生日占い</h1>
